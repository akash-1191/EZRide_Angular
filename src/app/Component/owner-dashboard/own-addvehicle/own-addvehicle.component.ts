...
@Component({
  selector: 'app-own-addvehicle',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './own-addvehicle.component.html',
  styleUrl: './own-addvehicle.component.css'
})
export class OwnAddvehicleComponent implements OnInit {
  ...
  redirectManagevihiclepage() {
    this.router.navigate(['/OwnerVehicle-dashboard/Myvehicle']);
  }
}